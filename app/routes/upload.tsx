...
function upload() {
    ...
    const handleAnalyze = async ({ companyName, jobTitle, jobDescription, file
        ...
        setStatusText('Uploding the file...')
        ...
        if (!imageFile.file) return setStatusText('Failed to convert image to pdf')
                    ...
                    {!isProcessing && (
                        <form id='upload-form' onSubmit={handleSubmit} className="flex flex-col gap-4 mt-8">
                            <div className='form-div'>
                                ...
                                <input type="text" placeholder='Company Name' name="comapny-name" id='comapny-name'></input>
                            </div>
                            <div className='form-div'>
                                <label htmlFor="job-title">Job Title</label>
                                <input type="text" placeholder='Job Title' name="job-title" id='job-title'></input>
                            </div>
                            <div className='form-div'>
                                <label htmlFor="job-description">Job Description</label>
                                <textarea rows={5} placeholder='Job Descript' name="job-description" id='job-description' />
                            </div>
